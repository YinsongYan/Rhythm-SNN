...
from ASRNN.spiking_seqmnist_model import SRNN_ALIF_2RNN
...
train_record_path = 'ASRNN_in1_T{0}_lens{1}_arch{2}_lr{3}_s{4}_tau5'\
    .format((784/args.in_size), args.lens, arch_name, learning_rate, seed)
train_chk_pnt_path = 'ASRNN_in1_T{0}_lens{1}_arch{2}_lr{3}_s{4}_tau5.pt'\
    .format((784/args.in_size), args.lens, arch_name, learning_rate, seed)
