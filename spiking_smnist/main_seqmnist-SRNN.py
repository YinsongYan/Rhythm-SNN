...
from SRNN.spiking_seqmnist_model import SRNN_multi_2RNN
...
snn_ckp_dir = './exp/SRNN/checkpoint/'
snn_rec_dir = './exp/SRNN/record/'
data_path = './data'
...
train_record_path = 'SRNN_in1_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_lr{5}_s{6}'\
    .format((784/args.in_size), args.decay, args.thresh, args.lens,arch_name, learning_rate, seed)
train_chk_pnt_path = 'SRNN_in1_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_lr{5}_s{6}.pt'\
    .format((784/args.in_size), args.decay, args.thresh, args.lens, arch_name, learning_rate, seed)
