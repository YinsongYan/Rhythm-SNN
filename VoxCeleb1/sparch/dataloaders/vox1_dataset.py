...
from sparch.dataloaders.utils_leaf.raw_waveform_parser import RawAudioParser
import soundfile as sf
from sparch.dataloaders.utils_leaf.utils import load_audio
import msgpack
...
class RawWaveformDataset(Dataset):
    def __init__(self, manifest_path, labels_map, audio_config, augment=False,
                 ...
                 cropped_read=False, frontend = 'fbank'):
