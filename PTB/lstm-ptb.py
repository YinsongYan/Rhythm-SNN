...
parser.add_argument('--nhid', type=int, default=400, help='number of hidden units per layer')  # 400  #  120  # 650
parser.add_argument('--bptt', type=int, default=200, help='sequence length')  # 25   # 200
...
if args.mode == "train":
    model_name = dataset_name + "_" + args.model + "_" + str(args.seed) + "_nhid" + str(args.nhid) + "_t" + str(args.bptt)
