...
def plot_images(original, perturbed, original_hidden_layers, perturbed_hidden_layers, noise_type):
    ...
    plt.show()
    plt.savefig('./plot/figures_attack/{}_skipASRNN_wb_hidden_representaion.pdf'.format(noise_type) , bbox_inches='tight')
...
def plot_diff_images(original, perturbed, original_hidden_layers, perturbed_hidden_layers, noise_type):
    ...
    plt.savefig('./plot/figures_attack/{}_skipASRNN_wb_hid_feats_diff.pdf'.format(noise_type) , bbox_inches='tight')
    plt.show()
