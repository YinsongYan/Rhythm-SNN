...
parser.add_argument('--cycle_max', nargs='*', default=[50, 50, 50], type=int, metavar='N',
					help='maximum repeating cycle')
parser.add_argument('--duty_cycle_min', nargs='*', default=[0.02, 0.02, 0.02], type=float, metavar='L',
...
parser.add_argument('--skip_length_min', nargs='*', default=[10, 10, 10], type=int, metavar='L',
