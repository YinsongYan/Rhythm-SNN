...
train_record_path = 'Skip_ASRNN_general_in1_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_pMax{5}_cMin{6}_cMax{7}_dcMin{8}_dcMax{9}_lr{10}'\
...
train_chk_pnt_path = 'Skip_ASRNN_general_in1_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_pMax{5}_cMin{6}_cMax{7}_dcMin{8}_dcMax{9}_lr{10}.pt'\
