...
from SRNN.spiking_psmnist_model import SRNN_multi_2RNN
...
train_record_path = 'SRNN_2RNN_in1_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_lr{5}'\
    .format((784/args.in_size), args.decay, args.thresh, args.lens,arch_name, learning_rate)
train_chk_pnt_path = 'SRNN_2RNN_in1_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_lr{5}.pt'\
    .format((784/args.in_size), args.decay, args.thresh, args.lens, arch_name, learning_rate)
