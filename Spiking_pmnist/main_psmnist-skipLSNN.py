...
from skip_LSNN.spiking_psmnist_mode import LSNN_2RNN_general
...
snn_ckp_dir = './exp/skip_LSNN/checkpoint/'
snn_rec_dir = './exp/skip_LSNN/record/'
data_path = './data'
...
train_record_path = 'Skip_LSNN_2RNN_general_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_pMax{5}_cMin{6}_cMax{7}_dcMin{8}_dcMax{9}_lr{10}'\
...
train_chk_pnt_path = 'Skip_LSNN_2RNN_general_T{0}_decay{1}_thr{2}_lens{3}_arch{4}_pMax{5}_cMin{6}_cMax{7}_dcMin{8}_dcMax{9}_lr{10}.pt'\
...
net = LSNN_2RNN_general(in_size=1)
net = net.to(device)
print (net)
