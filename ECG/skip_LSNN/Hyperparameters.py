...
parser.add_argument('--algo', default='LSNN', type=str, metavar='N',
...
parser.add_argument('--skip_length_min', nargs='*', default=[1, 1], type=int, metavar='L',
					help='skip_length for each layer')
parser.add_argument('--skip_length', nargs='*', default=[2, 3], type=int, metavar='L',
					help='skip_length for each layer')
