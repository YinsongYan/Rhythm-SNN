...
class Dense_test_1layer(nn.Module):
    def __init__(self, ):
        ...
        n = 64
        # DH-SFNN layer
        self.dense_1 = spike_dense_test_denri_wotanh_R(700, n, tau_ninitializer='uniform', low_n=2, high_n=6, vth=1,
                                                       dt=1, branch=4, device=device, test_sparsity=False)
...
class Dense_test_2layer(nn.Module):
    def __init__(self, ):
        ...
        self.dense_1 = Rhy_spike_dense_test_denri_wotanh_R(700, n, tau_ninitializer='uniform', low_n=0, high_n=8, vth=1,
                                                       dt=1, branch=8, cycle_min=10, cycle_max=60, duty_cycle_min=0.15, duty_cycle_max=0.99, phase_max=0.3, device=device)

        self.dense_2 = Rhy_spike_dense_test_denri_wotanh_R(n, n, tau_ninitializer='uniform', low_n=0, high_n=8, vth=1, dt=1,
                                                       branch=8, cycle_min=10, cycle_max=60, duty_cycle_min=0.15, duty_cycle_max=0.99, phase_max=0.3, device=device)
...
def train(epochs, criterion, optimizer, scheduler=None):
    ...
    prun_step_size = 20
    decay_rate = 0.5
    path = './model/gen_rhy/'  # .pth'
    if not os.path.exists(path):
        os.makedirs(path)
    name = 'gen_rhy_dense_2layer_branch8_1ms_final_64neuron_MG_bs100_nl0h8_dcl0.15h0.99_cy10-60_pm0.3_seed0_'
...
scheduler = StepLR(optimizer, step_size=35, gamma=.5)  # 20
epochs = 100
