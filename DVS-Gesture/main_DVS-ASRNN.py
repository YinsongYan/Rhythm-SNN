...
from ASRNN.spiking_dvs_model import SRNN_ALIF_1Adapt
...
snn_ckp_dir = './logs/SRNN_ALIF/checkpoint/'
snn_rec_dir = './logs/SRNN_ALIF/record/'
data_path = './data'
...
train_record_path = 'SRNN_ALIF_T{0}_lens{1}_arch{2}_lr{3}_s{4}'\
    .format((seq_len), args.lens, arch_name, learning_rate, seed)
train_chk_pnt_path = 'SRNN_ALIF_T{0}_lens{1}_arch{2}_lr{3}_s{4}.pt'\
    .format((seq_len), args.lens, arch_name, learning_rate, seed)
